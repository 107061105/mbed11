...
int main(){
   ...
   xbee.write("ATMY 0x410\r\n", 12);
   reply_messange(xbee_reply, "setting MY : 0x410");
   xbee.write("ATDL 0x420\r\n", 12);
   reply_messange(xbee_reply, "setting DL : 0x420");
   ...
   rpc_t.start(callback(&rpc_queue, &EventQueue::dispatch_forever));
   BSP_ACCELERO_Init();
